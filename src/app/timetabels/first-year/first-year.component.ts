...
export class FirstYearComponent implements OnInit {
  ...
  onPopupOpen(args: PopupOpenEventArgs): void {
    if (args.type === "RecurrenceAlert") {
      args.cancel = true;
      let data: { [key: string]: Object } = args.data as {
        [key: string]: Object;
      };
  ...
  constructor(
    private ttcs: TimeTableCRUDService,
    private scs: SubjectsService,
    private lcs: LecturerService,
    private hcs: HallService
  ) {}
