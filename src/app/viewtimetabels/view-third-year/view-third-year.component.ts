...
@Component({
  selector: 'app-view-third-year',
  templateUrl: './view-third-year.component.html',
  styleUrls: ['./view-third-year.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [DayService, WeekService, WorkWeekService, MonthService, AgendaService,DragAndDropService,ResizeService],
})
export class ViewThirdYearComponent implements OnInit {
